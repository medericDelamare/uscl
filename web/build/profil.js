...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.counter').each(function () {
  ...
  var vnd = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-chart-profil").data('vnd');
